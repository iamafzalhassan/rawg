...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  @override
  User? getCurrentUser() => supabaseClient.auth.currentUser;

  @override
  Future<ApiResult<User>> signIn({required String email, required String password}) async {
    try {
  ...
  @override
  Future<ApiResult<User>> signUp({required String email, required String name, required String password}) async {
    try {
