...
class GameOverviewModel extends GameOverview {
  GameOverviewModel({required super.id, required super.metacritic, required super.playtime, required super.descriptionRaw, required super.website, required super.publishers});

  factory GameOverviewModel.fromJson(Map<String, dynamic> json) => GameOverviewModel(
    id: json["id"],
  ...
  GameOverviewModel copyWith({int? id, int? metacritic, int? playtime, String? descriptionRaw, String? website, List<Publisher>? publishers}) => GameOverviewModel(
    id: id ?? this.id,
