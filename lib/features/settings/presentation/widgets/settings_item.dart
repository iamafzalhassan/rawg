...
class SettingsItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.0), color: AppPalette.black1),
      height: 80.0,
      ...
      child: Row(
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (value != null) ...[SizedBox(height: 4.0), Text(value!, style: AppFont.style(color: AppPalette.gray1, fontSize: 14))],
              ],
            ),
          ),
          ...
          if (showDropDown) Image.asset(AssetConstants.chevronIcon, width: 20.0),
        ],
      ),
    ),
  );
